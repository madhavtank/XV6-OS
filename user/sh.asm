...
0000000000000a62 <main>:
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     a9e:	58648493          	addi	s1,s1,1414 # 2020 <buf.1155>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa2:	06300913          	li	s2,99
     aa6:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aaa:	00001a17          	auipc	s4,0x1
     aae:	579a0a13          	addi	s4,s4,1401 # 2023 <buf.1155+0x3>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b38:	4ec50513          	addi	a0,a0,1260 # 2020 <buf.1155>
