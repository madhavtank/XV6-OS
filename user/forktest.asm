...
forktest(void)
{
  ...
  3e:	43e50513          	addi	a0,a0,1086 # 478 <set_priority+0xa>
  ...
  68:	42450513          	addi	a0,a0,1060 # 488 <set_priority+0x1a>
  ...
  b8:	42450513          	addi	a0,a0,1060 # 4d8 <set_priority+0x6a>
  ...
  d4:	3d850513          	addi	a0,a0,984 # 4a8 <set_priority+0x3a>
  ...
  ee:	3d650513          	addi	a0,a0,982 # 4c0 <set_priority+0x52>
